...
class TacheType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('nomTache')
            ->add('datePrevueDebut',DateType::class, array('label' => 'Date Debut','widget' => 'single_text','required' => false))
            ->add('datePrevuFin',DateType::class, array('label' => 'Date Fin','widget' => 'single_text','required' => false))
